...
hparams:
    ...
    precision: float32       # Compute precision: float32, bfloat16, or float16. Reduced precision uses PyTorch autocast for training/inference. Float16 CUDA training uses GradScaler.
